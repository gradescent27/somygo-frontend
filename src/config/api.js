...
export const apiService = {
 ...
 submitPaymentRequest: async (userData) => {
   const response = await fetch(getApiUrl(API_CONFIG.ENDPOINTS.SUBMIT_PAYMENT_REQUEST), {
     method: 'POST',
     headers: {
 ...
 automatePayment: async (requestId) => {
   const response = await fetch(getApiUrl(API_CONFIG.ENDPOINTS.AUTOMATE_PAYMENT), {
     method: 'POST',
     headers: {
       'Content-Type': 'application/json',
     },
 ...
 getPaymentStatus: async (requestId) => {
   const response = await fetch(getApiUrl(`${API_CONFIG.ENDPOINTS.GET_PAYMENT_STATUS}/${requestId}`), {
     method: 'GET',
     headers: {
       'Content-Type': 'application/json',
     }
 ...
 getCatalogProducts: async () => {
   const response = await fetch(`${API_CONFIG.SERVER_BASE_URL}/api/somygo-catalog${API_CONFIG.CATALOG_ENDPOINTS.GET_PRODUCTS}`, {
     method: 'GET',
     headers: {
       'Content-Type': 'application/json',
     }
 ...
 submitCatalogPaymentRequest: async (userData) => {
   const response = await fetch(`${API_CONFIG.SERVER_BASE_URL}/api/somygo-catalog${API_CONFIG.CATALOG_ENDPOINTS.SUBMIT_PAYMENT_REQUEST}`, {
     method: 'POST',
     headers: {
       'Content-Type': 'application/json',
     },
   ...
   if (!response.ok) {
     const errorData = await response.json();
     throw new Error(errorData.message || 'Failed to submit catalog payment request');
   }
 ...
 automateCatalogPayment: async (requestId) => {
   const response = await fetch(`${API_CONFIG.SERVER_BASE_URL}/api/somygo-catalog${API_CONFIG.CATALOG_ENDPOINTS.AUTOMATE_PAYMENT}`, {
     method: 'POST',
     headers: {
       'Content-Type': 'application/json',
     },
 ...
 getCatalogPaymentStatus: async (requestId) => {
   const response = await fetch(`${API_CONFIG.SERVER_BASE_URL}/api/somygo-catalog${API_CONFIG.CATALOG_ENDPOINTS.GET_PAYMENT_STATUS}/${requestId}`, {
     method: 'GET',
     headers: {
       'Content-Type': 'application/json',
     }
   ...
   if (!response.ok) {
     const errorData = await response.json();
     throw new Error(errorData.message || 'Failed to get catalog payment status');
   }
 ...
 getCatalogPaymentRequests: async (options = {}) => {
   ...
   if (!response.ok) {
     const errorData = await response.json();
     throw new Error(errorData.message || 'Failed to get catalog payment requests');
   }
 ...
 markCatalogInvoiceAsPaid: async (requestId, attemptIndex) => {
   const response = await fetch(`${API_CONFIG.SERVER_BASE_URL}/api/somygo-catalog${API_CONFIG.CATALOG_ENDPOINTS.MARK_AS_PAID}/${requestId}`, {
     method: 'POST',
     headers: {
       'Content-Type': 'application/json',
     },
     body: JSON.stringify(attemptIndex !== undefined ? { attemptIndex } : {})
   });
 ...
 // Get settings (requires admin secret)
 getSettings: async (adminSecret) => {
   const response = await fetch(`${API_CONFIG.SERVER_BASE_URL}/api/somygo-catalog/settings`, {
     method: 'GET',
     headers: {
       'Content-Type': 'application/json',
 ...
 // Update settings (requires admin secret)
 updateSettings: async (adminSecret, settingsData) => {
   const response = await fetch(`${API_CONFIG.SERVER_BASE_URL}/api/somygo-catalog/settings`, {
     method: 'PUT',
     headers: {
       'Content-Type': 'application/json',
